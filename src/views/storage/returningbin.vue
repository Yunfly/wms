    ...
    <div class="twoheight1">
      ...
      >
        ...
        <el-table-column label="状态" width="150">
          <template slot-scope="scope">
            <p class="statu0" v-if="scope.row.statu == 0">预报入库</p>
      ...
      <div v-else-if="editable == 1">
        <el-form v-model="reviewDetail" ref="reviewDetail">
          ...
          <el-form-item style="margin-top: 10px; margin-bottom: 0px" label="物品信息">
            <el-input
              placeholder="没有数据"
              v-model="reviewDetail.iteminfo"
            >
            </el-input>
          </el-form-item>
          <el-form-item style="margin-bottom: 0px" label="数量">
            <el-input
              placeholder="没有数据"
              v-model="reviewDetail.iteminfo"
            >
          ...
          <el-form-item style="margin-bottom: 0px" label="入库码">
            <el-input
              placeholder="没有数据"
              v-model="reviewDetail.iteminfo"
            >
          ...
          <el-form-item style="margin-bottom: 0px" label="卖家备注">
            <el-input
              placeholder="没有数据"
              v-model="reviewDetail.iteminfo"
            >
          ...
          <el-form-item style="margin-bottom: 0px" label="仓库说明">
            <el-input
              placeholder="没有数据"
              v-model="reviewDetail.iteminfo"
            >

  ...
  <div class="directorder-container">
    ...
    <div style="margin-bottom: 20px">
      <el-form
        ...
        style="width: 100%"
      >
      <el-form-item label="退货单号" required="" style="width: 30%">
        <el-input v-model="returningForm.returningnum"></el-input>
      </el-form-item>
      <el-form-item label="入库码" required="" style="width: 30%">
        <el-input v-model="returningForm.instockcode"></el-input>
      </el-form-item>
        <div
          style="
            display: flex;
        ...
        <el-table
          :data="returningForm.products"
          border
          class="product-table"
          style="width: 80%"
        >
          <el-table-column prop="name" label="物品信息">
    ...
    <div>
      ...
      >
        ...
        <el-form-item label="快速塑料袋:" prop="haocai1">
          <el-radio-group v-model="returningForm.haocai1">
        ...
        <el-form-item label="气泡袋:" prop="haocai2">
          <el-radio-group v-model="returningForm.haocai2">
            <el-radio :label="1">$0.15/重量低于0.42LB</el-radio>
            <el-radio :label="2">$0.20/重量低于0.42LB</el-radio>
            <el-radio :label="3">$0.50/重量低于0.42LB</el-radio>
            <el-radio :label="4">$1/重量低于0.42LB</el-radio>
        ...
        <el-form-item label="纸箱:" prop="haocai3">
          <el-radio-group v-model="returningForm.haocai3">
            <el-radio :label="1">$0.15/重量低于0.42LB</el-radio>
            <el-radio :label="2">$0.20/重量低于0.42LB</el-radio>
            <el-radio :label="3">$0.50/重量低于0.42LB</el-radio>
            <el-radio :label="4">$1/重量低于0.42LB</el-radio>
        ...
        <el-form-item label="服务:" prop="fuwu">
          <el-radio-group v-model="returningForm.fuwu">
...
export default {
  ...
  methods: {
    ...
    addproduct() {
      this.returningForm.products.push({
        name: '',
        count: 0,
        weight: 0,
        totalweight: 0,
    ...
    deleteRow(index) {
      this.returningForm.products.splice(index, 1)
    }
  }
}
</script>

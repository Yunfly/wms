  ...
  <div class="totalorder-container">
    <div class="filter-container">
      <el-form :inline="true" :model="searchForm" ref="searchForm">
        ...
        <el-form-item label="操作:" prop="contact">
          <el-select v-model="searchForm.contact" placeholder="请选择">
            <el-option label="入库" value="1"> </el-option>
            <el-option label="调库" value="2"> </el-option>
          </el-select>
        </el-form-item>
    ...
    <div class="twoheight1">
      ...
      >
        ...
        <el-table-column label="动作" width="150">
          <template slot-scope="scope">
            <p class="statu0" v-if="scope.row.statu == 0">清理库存</p>
            <p class="statu1" v-if="scope.row.statu == 1">调库</p>
            <p class="statu2" v-if="scope.row.statu == 2">订单发货</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="物流信息">
          <template slot-scope="scope">
            ...
            <p>快递费：{{ ifempty(scope.row.name) }}</p>

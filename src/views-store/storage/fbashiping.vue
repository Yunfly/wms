  ...
  <div class="forecaststorage-container">
    ...
    <div class="">
      ...
      >
        ...
        >
          <el-input
            v-model="storageFrom.recipientcall"
        ...
        >
          <el-input
            v-model="storageFrom.recipientaddress1"
        ...
        >
          <el-input
            v-model="storageFrom.recipientaddress2"
            placeholder="请输入收件人地址"
          ></el-input>
        </el-form-item>
        <el-form-item label="区域:" prop="area" style="width:60%">
          <el-select
            v-model="storageFrom.area"
            placeholder="请选择"
